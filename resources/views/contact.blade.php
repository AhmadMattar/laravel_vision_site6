        ...
        <div class="container" data-aos="fade-up">
            <div class="row mt-5">
                ...
                <div class="col-lg-8 mt-5 mt-lg-0">
                    ...
                    <form action="{{route('contactSubmit')}}" method="post" role="form" >
                    @csrf
                    <div class="row">
                    ...
                    <div class="form-group mt-3">
                        <textarea class="form-control @error('message') is-invalid @enderror" name="message" rows="8" placeholder="Message"></textarea>
                        @error('message')
                            <small>{{$message}}</small>
                        @enderror
                    </div>
